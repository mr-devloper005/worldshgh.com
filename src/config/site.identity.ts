export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'worldshgh',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Worldshgh',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'worldshgh.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://worldshgh.com',
